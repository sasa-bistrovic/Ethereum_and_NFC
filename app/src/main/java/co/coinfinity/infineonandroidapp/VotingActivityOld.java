    ...
    private void resolveIntent(Intent intent) {
        ...
        Thread thread = new Thread(() -> {
            ...
            try {
                ...
                VotingUtilsOld.vote(contractAddress.getText().toString(), MifareUltralight.get(tagFromIntent), pubKeyString, ethAddress, votingName.getText().toString(), idx, gasPrice, gasLimit, this);
