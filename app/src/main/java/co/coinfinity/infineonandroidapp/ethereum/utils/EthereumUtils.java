...
public class EthereumUtils {
    ...
    public static Pair<EthSendTransaction, GenerateSignatureResponseApdu> sendTransaction(
            ...
            String to, BigInteger value, MifareUltralight isoTag,
...
/*
            TransactionReceipt transactionReceipt = Transfer.sendFunds(
                                web3, credentials,
                    to,
                    SendErc20TokensActivity.ethvalue, Convert.Unit.ETHER).sendAsync().get()  // 1 wei = 10^-18 Ether
                    ;
*/
        ...
        byte[] encodedTransaction2 = encode(rawTransaction, chainId);
        Sign.SignatureData signatureData = Sign.signMessage(
                encodedTransaction2, credentials.getEcKeyPair());
...
*/
        /*
        String hexValue = Numeric.toHexString(TransactionEncoder.encode(rawTransaction, eip155SignatureData));
    ...
    /*
    public static EthSendTransaction sendTransaction(
            BigInteger gasPrice, BigInteger gasLimit, String from,
            String to, BigInteger value, MifareUltralight isoTag,
            String publicKey, String data, String url, byte chainId, int keyIndex, byte[] pin) throws Exception {
        ...
        return web3.ethSendTransaction(transaction)
                .send();
    }
    */
