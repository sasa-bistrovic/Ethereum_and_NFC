...
/*
    public static TransactionReceipt productDetail(String contractAddress, String ethAddress,MifareUltralight tag, String publicKey, String from, String productid, String productname,String time, String date, String manufacturer, BigInteger gasPrice, BigInteger gasLimit, String pubKey, Activity activity) throws Exception {
    ...
    private static ProductDetail prepareWriteProductDetailContract(String contractAddress, MifareUltralight tag, String publicKey, String from, BigInteger gasPrice, BigInteger gasLimit, Activity activity) {
    ...
    private static ProductDetail prepareReadOnlyProductContract(String contractAddress, String from, BigInteger gasPrice, BigInteger gasLimit, Activity activity) {
        Web3j web3j = Web3j.build(new HttpService(UiUtils.getFullNodeUrl(activity)));
