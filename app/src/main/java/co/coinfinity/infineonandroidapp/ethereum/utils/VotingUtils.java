...
public class VotingUtils {
     ...
     * @throws Exception
     */
    public static TransactionReceipt vote(String contractAddress, MifareUltralight tag, String publicKey, String from,
     ...
     * @return
     */
    private static Voting prepareWriteVotingContract(String contractAddress, MifareUltralight tag, String publicKey, String from,
