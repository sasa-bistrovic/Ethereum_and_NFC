...
public class VotingUtilsOld {
     ...
     * @throws Exception
     */
    public static TransactionReceipt vote(String contractAddress, MifareUltralight tag, String publicKey, String from, String votingName, int vote, BigInteger gasPrice, BigInteger gasLimit, Activity activity) throws Exception {
     ...
     * @return
     */
    private static VotingOld prepareWriteVotingContract(String contractAddress, MifareUltralight tag, String publicKey, String from, BigInteger gasPrice, BigInteger gasLimit, Activity activity) {
        /*
